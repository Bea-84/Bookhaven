...
INSERT INTO `categorias` VALUES ('Fantasia','Todos los públicos'),('Ficción','Todos los públicos'),('Infantil','niños'),('Novela histórica','adultos'),('Thriller','+18');
...
CREATE TABLE `productos` (
  ...
  CONSTRAINT `fk_productoCategoria` FOREIGN KEY (`idCategoria`) REFERENCES `categorias` (`idCategorias`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `productos` VALUES (1,'Alicia en el país de las maravillas',8,'Obra clássica','Infantil','i1.jpg'),(2,'Onin',10,'Las aventuras de Onin','Infantil','i2.jpg'),(3,'Los pilares de la tierra',20,'Historia siglo XII','Novela histórica','i3.jpg'),(4,'Ultimos días en Berlín',21,'Finalista premio planeta','Novela Histórica','i4.jpg'),(5,'El código da Vinci',15,'Misterio y suspense','Thriller','i5.jpg'),(6,'El silencio de los corderos',12,'Suspense y terror','Thriller','i6.jpg'),(7,'Harry Potter',11,'Saga JKRowling','Fantasia','i7.jpg'),(8,'El señor de los anillos',25,'Trilogía','Fantasia','i8.jpg'),(9,'Cien años de soledad',9,'Autor latam','Ficción','i9.jpg'),(10,'1984',14,'Historia de un mundo autoritario','Ficción','i10.jpg');
...
-- Dump completed on 2023-11-21 11:39:49
